...
4:   fieldDbEntry{"PROTOCOL",       1, fieldToStringProtocolNumber, "IP protocol byte."},
...
func fieldToStringMsecDuration(data []byte) string {
	...
	return fmt.Sprint(duration.Seconds())
}

func fieldToStringSamplingInterval(data []byte) string {
	return fieldToStringUInteger(data)
}
...
func fieldToStringProtocolNumber(data []uint8) string {
	switch data[0] {
	case 1: return "\"ICMP\""
	case 2: return "\"IGMP\""
	case 4: return "\"IP\""
